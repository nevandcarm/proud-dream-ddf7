...
```
npm create cloudflare@latest -- --template=cloudflare/templates/proud-dream-ddf7
```

## Preview Deployment

A live public deployment of this template is available at [https://proud-dream-ddf7.templates.workers.dev](https://proud-dream-ddf7.templates.workers.dev)
